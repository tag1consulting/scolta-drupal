...
### Changed
- `drush queue:run scolta_rebuild -v` logs a progress line per chunk (`Progress 213/400 chunks (53%) Chunk 213 (21300 pages)`); the per-phase memory lines alone gave no sense of how far along a build was.
